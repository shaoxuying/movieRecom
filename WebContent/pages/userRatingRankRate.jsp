		...
		<div class="page-content" style=" margin-top: 80px;">
			<div class="page-header">
				<h1>
					您的评分记录：
					<div class="btn-group">
					<a href="/movieRecom/movie/queryRatingByUserIdRankTime.action" class="btn ">按时间排序</a>
					<a href="/movieRecom/movie/queryRatingByUserIdRankRate.action" class="btn btn-info">按评分排序</a>
					</div>
